...
func main() {
	...
	transactionHander := handler.NewTransactionHandler(transactionService)
	...
	api.GET("/campaigns/:id/transactions", authMiddleware(authService, userService), transactionHander.GetCampaignTransactions)
	router.Run()
